...
class profile extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            Experience: [{
                ...
                start_date: "Nov 27",
                end_date: "Jul 30",
                description: "Got training in Web Development where I created a POC on Food Ordering System using technologies like HTML, CSS, JavaScript, PHP and MySql."
            }
                , {
                title: "Sjsu Student",
                company: "Deep technologies",
    ...
    componentDidMount() {
        ...
        axios.get(`${ROOT_URL}/user/5c0508c1b328b5105c67b9a9`)
            .then((response) => {
    ...
    render() {
        ...
        if (this.state.Experience && this.state.Experience.length > 0) {
            experiences = this.state.Experience.map(exp => {
                return (<tr>
                    ...
                    <td>
                        {/* <div style={{ "margin-top": "-89px", "margin-left": "0%" }}>
                            <i style={{ color: "#0073b1", fontSize: "22px", cursor: "pointer" }} className="ion-edit" data-toggle="modal" data-target="#myModal"></i>
                        </div>

                        <div>
                            <i style={{ color: "#0073b1", fontSize: "22px", cursor: "pointer" }} className="ion-plus-round" data-toggle="modal" data-target="#myModal3"></i>
        ...
        // else {
        //     experiences = <div style={{ color: "#200755", padding: "10px 10px 10px 0px" }}>
                    ...
                    <div class="col-sm-8 col-md-8 col-lg-8" >
                        ...
                        <div style={{ marginTop: "20px" }} class="card myConnections_1">
                            ...
                            <div style={{ "margin-top": "-35px", "margin-left": "96%" }}>
                                <i style={{ color: "#0073b1", fontSize: "22px", cursor: "pointer" }} className="ion-edit" data-toggle="modal" data-target="#myModal"></i>
                                <div>
                                    <i style={{ color: "#0073b1", fontSize: "22px", cursor: "pointer" }} className="ion-plus-round" data-toggle="modal" data-target="#myModal2"></i>
                        ...
                        <div style={{ marginTop: "20px" }} class="card myConnections_1">
                            ...
                            <div style={{ "margin-top": "-35px", "margin-left": "96%" }}>
                                <i style={{ color: "#0073b1", fontSize: "22px", cursor: "pointer" }} className="ion-edit" data-toggle="modal" data-target="#myModal"></i>
                                <div>
                                    <i style={{ color: "#0073b1", fontSize: "22px", cursor: "pointer" }} className="ion-plus-round" data-toggle="modal" data-target="#myModal"></i>
                            ...
                            <div className="manager">
                                <div style={{ marginTop: "-5%" }}><span className="manager-text_11">Node Js</span></div>
